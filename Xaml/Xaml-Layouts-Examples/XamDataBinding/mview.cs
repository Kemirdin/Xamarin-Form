namespace ＭvvmDemo.ViewModels {
    public class MasterViewModel : MvvmHelpers.BaseViewModel {
        ...
        public IList<Grouping<string, DetailViewModel>> GroupDetails {
            get {
                return (from detail in details orderby detail.Actor.Sign group detail by detail.Actor.Sign into actorGroup select new Grouping<string, DetailViewModel> (actorGroup.Key, actorGroup))
                    .ToList ();
            }
        }
